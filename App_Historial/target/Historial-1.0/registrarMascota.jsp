...
<%-- Document : index Created on : 2 set. 2023, 10:30:10 Author : luisd --%>
...
<html>
  ...
  <body onload="establecerFecha();">
    <div class="madre" id="madre">
      <form
        action="registroMascota"
        method="post"
        enctype="multipart/form-data"
        class="contenedorIntranet"
      >
        <% 
        ...
        <h2 class="introIntranet" style="font-size: 35px; text-align: center">
          Laica
        </h2>
        ...
        <h5 class="subIntranet" style="font-size: 20px; margin-bottom: -10px">
        ...
        <select
          name="especieMascota"
          class="datos"
          style="padding-left: 10px; font-size: 20px; width: 100%"
          required
        >
        ...
        <button
          class="datos"
          style="color: white; background-color: black; cursor: pointer"
        >
          Registrar Mascota
        </button>
      </form>
    ...
    <script>
      ...
      if (localStorageIdUsuario) {
        ...
        document.getElementById("userId").value = localStorageIdUsuario;
      } else {
