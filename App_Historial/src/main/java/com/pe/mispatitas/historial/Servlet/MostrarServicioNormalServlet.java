 ...
 */
@WebServlet(urlPatterns = {"/MostrarServicioNormal"})
public class MostrarServicioNormalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("servicioNormal.jsp").forward(request, response);
    }
