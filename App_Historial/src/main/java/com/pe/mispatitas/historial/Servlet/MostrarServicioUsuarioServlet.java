 ...
 * @author Luis Santos
 */
@WebServlet(urlPatterns = {"/MostrarServicioUsuario"})
public class MostrarServicioUsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Servicio> listaServicio = dao.servicioSel();
        ...
        request.getRequestDispatcher("servicioUsuario.jsp").forward(request, response);
    }
