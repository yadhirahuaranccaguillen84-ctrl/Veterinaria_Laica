...
public class RecuperarIdServicioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer idServicio = Integer.valueOf(request.getParameter("actualizar"));
        String imagenModificar=request.getParameter("imagenModificar");
        DaoServicio dao = new DaoServicioImpl();
        Servicio listaServicio = dao.servicioGet(idServicio);
        request.setAttribute("listaServicio", listaServicio);
        request.setAttribute("imagenModificar", imagenModificar);
