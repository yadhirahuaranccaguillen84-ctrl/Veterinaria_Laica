 ...
 * @author Luis Santos
 */
@WebServlet(name = "EliminarServicioServlet", urlPatterns = {"/EliminarServicio"})
public class EliminarServicioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Integer idServicio = Integer.valueOf(request.getParameter("eliminar"));
        DaoServicio dao = new DaoServicioImpl();
        System.err.println(idServicio);
        dao.servicioDel(idServicio);
