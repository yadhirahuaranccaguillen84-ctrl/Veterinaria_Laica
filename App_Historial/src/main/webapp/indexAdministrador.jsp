...
<html>
  ...
  <body>
      ...
      <div class="contenedor">
        <div class="caja">
          <div class="caja__texto">
            ...
            <p>
              "El cuidado de tus mascotas es nuestra especialidad, ¡porque su
      ...
      <div class="contenedor">
        <div class="caja3">
          <div class="caja3__texto">
            ...
            <p>
              "En nuestra veterinaria, ofrecemos un servicio de calidad
              excepcional para garantizar la salud y felicidad de tus queridas
              mascotas. Confía en nuestros expertos cuidadores para brindarles
    ...
    <section class="caracteristica">
      <div class="contenedor caracteristicas">
        <div class="carac_1">
          ...
          <p>
            En nuestra veterinaria, entendemos que cada mascota es única y
            especial. Nos enorgullece ofrecer un cuidado veterinario excepcional
            que va más allá del tratamiento médico. Es un compromiso con el
            bienestar y la felicidad de tus fieles amigos de cuatro patas.
          </p>
        </div>
        <div class="carac_2">
          <h4 class="centrar-texto">Capacitacion</h4>
          <p>
            En nuestra veterinaria, no solo nos preocupamos por la salud de tus
            mascotas, sino que también creemos en empoderar a nuestros clientes
            con conocimientos y recursos para el cuidado responsable de sus
            amigos peludos.
          </p>
        </div>
        <div class="carac_3">
        ...
        <div class="carac_4">
          ...
          <p>
            Cuando nuestras queridas mascotas se enfrentan a la enfermedad,
            merecen el mejor cuidado posible. En nuestra clínica veterinaria,
            nos dedicamos a brindar tratamientos compasivos y efectivos para
            ayudar a las mascotas a recuperar su salud y vitalidad.
          </p>
        </div>
        <div class="carac_5">
          <h4 class="centrar-texto">Atencion</h4>
          <p>
            Además, valoramos profundamente la relación con nuestros clientes.
            Sabemos que cada mascota es especial y que cada dueño tiene
            preocupaciones y preguntas únicas. Estamos disponibles para
            escucharte, responder tus dudas y brindarte apoyo en cada paso del
            camino.
          </p>
        </div>
      </div>
    ...
    <script>
      ...
      localStorage.setItem('idAdministrador', idAdministrador);
    </script>
  </body>
</html>
